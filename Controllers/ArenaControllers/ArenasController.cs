...
namespace HockeyPlanner2019.Controllers.ArenaControllers
{
    public class ArenasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ArenaName,StreetAddress,ZipCode,City,Country,PhoneNumber1,PhoneNumber2,Email,HomePage")] Arena arena)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ArenaName,StreetAddress,ZipCode,City,Country,PhoneNumber1,PhoneNumber2,Email,HomePage")] Arena arena)
        {
            if (id != arena.Id)
            {
                return NotFound();
